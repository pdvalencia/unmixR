...
**unmixR** is an R package for person-centred mixture modelling. It provides a unified, flexible interface for **Latent Class Analysis (LCA)** and **Latent Profile Analysis (LPA)**, supporting a wide range of measurement models, structural models, and multi-step estimation strategies — all implemented from scratch in pure base R with no heavy dependencies.
